...
// export const getOptionDetails = (optionId: any, fundmeId: any) => API.get(`/api/fundme/${fundmeId}/details/${optionId}`);
// export const supportCreator = (data: any) => API.post("/api/fundme/support", data);
...
export const acceptFundOption = (data: any) => API.post('/api/fundme/accept', data);
export const declineFundOption = (data: any) => API.post('/api/fundme/decline', data);
export const winFundOption = (data: any) => API.post('/api/fundme/win/option', data);
export const getFundmeOptions = (fundmeId: any) => API.get(`/api/fundme/${fundmeId}/options`);
