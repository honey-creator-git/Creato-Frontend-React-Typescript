...
const PostFanwallFundme = () => {
    ...
    useEffect(() => {
        if (embedUrl.indexOf("youtube") && youtube_parser(embedUrl)) {
            setType(1);
                        ...
                        <div className="dare-post-fanwall-main">
                            ...
                            {fanwall.video ?
                                ...
                                <div onClick={() => {
                                    ...
                                    dispatch({ type: SET_FANWALL, payload: state })
                                    navigate(`/fundme/fanwall/post/${fundmeId}/upload`);
                                }}>
                                    <ContainerBtn
...
export default PostFanwallFundme;